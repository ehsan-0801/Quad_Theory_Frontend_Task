...
const RecommendItems = () => {
    ...
    // useEffect(() => {
    //     console.log(' Recommended Items updated:', recommendedItems);
    // }, [recommendedItems]);

    const addRecommendedProduct = async data => {
        console.log(data)
        const newProduct = {
            Id: uuidv4(),
            Name: data.Name,
    ...
    const endIndex = (startIndex + itemsPerSlide) % recommendedItems.length;
    const currentItems = recommendedItems.slice(startIndex, endIndex >= startIndex ? endIndex : recommendedItems.length);
                ...
                <>
                    ...
                    <div className="modal active">
                        <div className="modal-content">
                            ...
                            <form className='w-80' onSubmit={ handleSubmit(addRecommendedProduct) }>
                                <h1 className='text-center font-bold text-orange-500 p-1 border-solid border-2 border-orange-500 my-2'>Add a Recommended item in the list</h1>
                                <div className="mb-4">
